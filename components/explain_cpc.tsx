        ...
        <div className="py-12 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="lg:text-center">
                    <h2 className="text-base text-[#8318bd] font-medium tracking-wide uppercase">
                        Types of Axis
                    </h2>
                    ...
                    <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                        Each axis is an indicator of your ideology after you answer <br/> our ideological analysis questions.
                    </p>
                </div>
                    ...
                    <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                        {explains.map((explain) => (
                            <div key={explain.name} className="relative">
                                <dt>
                                    <div className="absolute flex items-center justify-center h-12 w-12 rounded-md bg-[#8318bd] text-white">
